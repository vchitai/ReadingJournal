...
public class BookContract {
    ...
    public static final class BookEntry implements BaseColumns {
        ...
        public final static String COLUMN_BOOK_GENRES      = "genres";
        public final static String COLUMN_BOOK_IMAGE_ID    = "image_id";
        public final static String COLUMN_BOOK_NOTES       = "notes";
        public final static String COLUMN_BOOK_QUOTES      = "quotes";
